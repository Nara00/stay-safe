    ...
    render() {
        return (
            <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar">
                ...
                <ul class="navbar-nav d-flex d-sm-flex d-md-none d-lg-none d-xl-none d-xxl-none flex-row align-items-end ms-auto">
                <li class="nav-item"><a class="nav-link nav-link-icon" href="#" ><i class="fas fa-exclamation icon-act"></i></a></li>
                <li class="nav-item nav-item-icon"><a class="nav-link nav-link-icon" href="#" ><i class="fa fa-map-o icon-desact"></i></a></li>
                <li class="nav-item"><a class="nav-link nav-link-icon" href="#" ><i class="far fa-user icon-desact"></i></a></li>
                    </ul>
