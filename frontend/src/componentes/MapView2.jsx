...
class MapView2 extends React.Component {
    ...
    state = {
        location: [],
        loaction2:
            [{ lat: -31.420223, lng: -64.195015 },
            { lat: -31.422712, lng: -64.19897 },
            { lat: -31.433846, lng: -64.22163 },
            { lat: -31.42275, lng: -64.188324 },
            { lat: -31.415974, lng: -64.19467 }]
        ...
        return (
            <>
                <Map
                    ...
                    positions={this.state.loaction2}
                >
                    {/* {this.displayMarkers()} */}
                    <HeatMap
                        gradient={gradient}
